export function FlutterIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <path d="M14 26L28 12H40L20 32L14 26Z" fill="#54C5F8" />
      <path d="M20 32L28 40H40L26 26L20 32Z" fill="#01579B" />
      <path d="M14 26L20 32L26 26L20 20L14 26Z" fill="#29B6F6" />
    </svg>
  );
}

export function DartIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="-40 -40 208 208" fill="none">
...
export function GitIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <circle cx="24" cy="24" r="4" fill="#F03C2E" />
      <circle cx="14" cy="14" r="3.2" fill="#F03C2E" />
      <circle cx="34" cy="14" r="3.2" fill="#F03C2E" />
      <circle cx="14" cy="34" r="3.2" fill="#F03C2E" />
      <path d="M24 24L14 14M24 24L34 14M24 24L14 34" stroke="#F03C2E" strokeWidth="2" />
    </svg>
  );
}
