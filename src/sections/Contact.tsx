  ...
  return (
    <section id="contact" className="bg-paper py-20 md:py-40">
      <div className="container-px">
        ...
        <div className="mt-10 grid grid-cols-2 sm:flex sm:flex-wrap gap-4 sm:gap-10 border-t border-line pt-8">
          <a
          ...
          >
            Email
            <span className="inline-block transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 text-base">?</span>
          </a>
          <a
